    ...
    <>
      ...
      <div className="w-full">
        <div className="w-full max-w-[1200px] mx-auto py-6 px-2 text-neutral-700 text-sm">
          <p>
            The University of Delphis, the state of Delphis's oldest public
          ...
          <p className="mt-4">
            In 1818, the federal government authorized the Delphis Territory to
            ...
            March 2, 1819, and Delphis was officially admitted to the Union on
            ...
            University of the State of Delphis.” Delphis, then the state's
          ...
          <p className="mt-4">
            In 1838, The University of Delphis became the first in the state to
          ...
          <p className="mt-4">
            ...
            buildings on the UD campus. Of the principal buildings remaining
          ...
          <p className="mt-4">
            ...
            President Stuart R. Bell, The University of Delphis is flourishing
            and experiencing increased interest from across the nation and
            around the globe each year. UD offers 70 undergraduate programs
          ...
          <p className="mt-4">
            The University of Delphis is one of three campuses in The University
            of Delphis System, all of which are governed by The University of
            Delphis Board of Trustees.
          </p>
          <p className="mt-4">
            Established in 1969, The University of Delphis System includes The
            University of Delphis (located in Delphis), The University of
            Delphis at Birmingham and The University of Delphis in Huntsville.
            The System is governed by a self-nominating board of 15 elected and
            two ex-officio members.
          </p>
          <p className="mt-4">
            The constitution of the State of Delphis provides that the board is
            composed of three members from the congressional district in which
            the Delphis campus is located and two members from each of the other
            six congressional districts. The governor and the state
          ...
          <p className="mt-4">
            ...
            doctoral research universities in The University of Delphis System.
          ...
          <p className="mt-4">
            ...
            responsibility to the public and political bodies of Delphis. Rules,
            policies and procedures are promulgated to ensure that, through The
            University of Delphis System Office, the necessary flow of
